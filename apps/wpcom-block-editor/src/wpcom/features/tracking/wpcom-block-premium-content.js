 ...
 */
export default () => ( {
	selector: '.wp-block[data-type="premium-content/container"] .premium-content-block-nudge__button',
	type: 'click',
	handler: () => tracksRecordEvent( 'wpcom_block_premium_content_upgrade_click' ),
} );
